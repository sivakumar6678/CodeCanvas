...
export const builtinTools = [
  {
    ...
    description: 'Generate beautiful and accessible color palettes instantly for your UI designs using AI-powered suggestions.',
    fullDescription: 'Create harmonious color combinations for your projects using our AI-powered color palette generator. Focus on accessibility, contrast ratios, and modern UX design principles to ensure your palette looks stunning on any device.',
    icon: '🎨',
    category: 'Colors',
  ...
  },
  {
    ...
    description: 'Design stunning CSS gradients with intuitive controls and instant AI-based color matching.',
    fullDescription: 'Create and export beautiful linear and radial gradients with our interactive generator. Fine-tune color stops, angles, and combinations to add modern depth and vibrancy to your web interfaces.',
    icon: '🌈',
    category: 'Colors',
  ...
  },
  {
    ...
    description: 'Craft perfect CSS box shadows instantly to give your UI elements depth, elevation, and professional polish.',
    fullDescription: 'Easily generate complex CSS box shadows with intuitive sliders for offset, blur, spread, and opacity. Preview your shadows in real-time and let AI suggest trendy elevations inspired by modern SaaS applications.',
    icon: '💫',
    category: 'Effects',
  ...
  },
  {
    ...
    description: 'Compress and optimize images for the web in seconds to drastically improve page load speeds and SEO.',
    fullDescription: 'Reduce image file sizes without compromising quality using advanced compression algorithms. Fast page loads are critical for SEO and UX, making this tool essential before deploying graphic assets.',
    icon: '🖼️',
    category: 'Images',
  ...
  },
  {
    ...
    description: 'Build responsive CSS Grid and Flexbox layouts visually and generate production-ready code instantly.',
    fullDescription: 'Design responsive page structures visually without writing boilerplate CSS. Let our AI suggest optimized grid templates and flexbox alignments that seamlessly adapt to mobile, tablet, and desktop viewports.',
    icon: '📐',
    category: 'Layout',
  ...
  },
  {
    id: 'brainstorming',
    name: 'Brainstorming',
    description: 'Turn vague ideas into structured project plans with an interactive AI assistant that maps out features and timelines.',
    fullDescription: 'Stuck on where to start? Chat with our AI to brainstorm features, select appropriate tech stacks, and generate a structured roadmap for your next web application or mobile app.',
    icon: '💡',
    category: 'Ideas',
  ...
  },
  {
    ...
    description: 'Generate boilerplate code, complex algorithms, or custom components instantly using context-aware AI.',
    fullDescription: 'Stop writing repetitive boilerplate code. Use specific prompts to instantly generate optimized React components, backend logic, or utility functions tailored perfectly to your project architecture.',
    icon: '💻',
    category: 'Code',
  ...
  },
  {
    ...
    description: 'Discover personalized project ideas tailored to your tech stack and skill level to build a standout portfolio.',
    fullDescription: 'Looking to build your portfolio but lack inspiration? Enter the technologies you want to learn, and our AI will generate unique, challenging, and highly employable project suggestions with step-by-step roadmaps.',
    icon: '🚀',
    category: 'Ideas',
...
// Structured category system with parent/child relationships
export const categoryStructure = {
  'Design Tools': {
    icon: '🎨',
    subcategories: ['Colors', 'Design', 'Design Inspiration', 'Icons & SVG', 'Shapes & Effects']
  },
  'Development Tools': {
    icon: '⚙️',
    subcategories: ['Dev Tools', 'CSS Tools', 'JavaScript Libraries', 'VS Code Extension', 'Browser Extensions']
  },
  'UI Resources': {
    icon: '🖥️',
    subcategories: ['UI Resources', 'Animations', 'Color Tools']
  },
  'Built-in Tools': {
    icon: '🔧',
    subcategories: ['Effects', 'Images', 'Layout', 'Ideas', 'Code']
  },
  'Performance & Portfolio': {
    icon: '📊',
    subcategories: ['Performance', 'Portfolio']
  }
};
